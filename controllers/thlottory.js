...
const  ThLotory = async function (req, res) {
  ...
  res.status(400).json({ success: true, title: contentSnippetTranform[0][0] , jackpot: contentSnippetTranform[11][0] , two_digit: contentSnippetTranform[12][0] , tree_digit_prev: contentSnippetTranform[13][0], tree_digit_end: contentSnippetTranform[14][0], pubDate:feed.items[0].pubDate});
